    ...
    return (
      <div className='min-h-screen' style={{ backgroundImage: `url(${fondo})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className='container py-20'>
            ...
            ? <div className='flex flex-col justify-center items-center bg-white p-10 rounded-lg lg:w-3/5 max-w-[700px] mx-auto' id='contact'>
              ...
              <div className='socialmedia flex flex-col'>
                ...
                <div className='flex justify-center items-center gap-6'>
                  ...
                  <a href='https://open.spotify.com/intl-es/artist/72kQGFiZ6YbY4gsjkFUMsP?si=468d5fc29c6e4263' target='_blank' rel='noreferrer'><Icon icon='mdi:spotify' className='text-3xl text-slate-900 hover:text-red-500 duration-300 cursor-pointer' /></a>
                  <a href='https://www.instagram.com/lambdabeats' target='_blank' rel='noreferrer'><Icon icon='mdi:instagram' className='text-3xl text-slate-900 hover:text-red-500 duration-300 cursor-pointer' /></a>
                  <a href='https://www.youtube.com/@lambdabeats' target='_blank' rel='noreferrer'><Icon icon='mdi:youtube' className='text-3xl text-slate-900 hover:text-red-500 duration-300 cursor-pointer' /></a>
          ...
          <div className='separator h-[100px]' />
        </div>
      </div>
    )
  }
